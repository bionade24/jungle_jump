...
import eu.bionade24.junglejump.components.ShaderSPIRVUtils.SPIRV;
import eu.bionade24.junglejump.components.Frame;
...
import static eu.bionade24.junglejump.components.AlignmentUtils.alignas;
import static eu.bionade24.junglejump.components.AlignmentUtils.alignof;
import static eu.bionade24.junglejump.components.ShaderSPIRVUtils.ShaderKind.FRAGMENT_SHADER;
import static eu.bionade24.junglejump.components.ShaderSPIRVUtils.ShaderKind.VERTEX_SHADER;
import static eu.bionade24.junglejump.components.ShaderSPIRVUtils.compileShaderFile;
...
public class VulkanWindow {
    ...
    private static class HelloTriangleApplication {
        ...
        private static final /* uint16_t */ short[] INDICES = { 0, 1, 2, 2, 3, 0 };
        ...
        public void run() {
            imageFilepaths.add("graphics/jungle.png");
            imageFilepaths.add("graphics/ape.png");
            initWindow();
            initVulkan();
            mainLoop();
            cleanup();
        ...
        private void initWindow() {
            ...
            // However, I will show you how can you pass a user pointer to glfw in Java just
        ...
        private void createLogicalDevice() {
            ...
            try (MemoryStack stack = stackPush()) {
                ...
                VkDeviceQueueCreateInfo.Buffer queueCreateInfos = VkDeviceQueueCreateInfo
                        .callocStack(uniqueQueueFamilies.length, stack);
        ...
        private void createGraphicsPipeline() {
            ...
            try (MemoryStack stack = stackPush()) {
                ...
                SPIRV vertShaderSPIRV = compileShaderFile("shaders/shader_textures.vert", VERTEX_SHADER);
                SPIRV fragShaderSPIRV = compileShaderFile("shaders/shader_textures.frag", FRAGMENT_SHADER);
                ...
                VkPipelineShaderStageCreateInfo.Buffer shaderStages = VkPipelineShaderStageCreateInfo.callocStack(2,
                        stack);
                ...
                if (vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, pipelineInfo, null,
        ...
        private void createTextureImages() {
            ...
            try (MemoryStack stack = stackPush()) {
                ...
                String filename = Helper.resolvePath("graphics/jungle.png");
                ...
                createImage(pWidth.get(0), pHeight.get(0), VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL,
        ...
        private void createUniformBuffers() {
            ...
            try (MemoryStack stack = stackPush()) {
                ...
                for (int i = 0; i < swapChainImages.size(); i++) {
                    createBuffer(UniformBufferObject.SIZEOF, VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT,
                            VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, pBuffer,
                            pBufferMemory);
        ...
        private void updateUniformBuffer(int currentImage) {
            ...
            try (MemoryStack stack = stackPush()) {
                ...
                ubo.view.lookAt(0.f, 0.f, 2.f, 0.f, 0.f, 0.f, 0.f, -1.f, 0.f);
                ubo.proj.setPerspective(0.5f, (float) swapChainExtent.width() / (float) swapChainExtent.height(), 1.f, 10.f);
        ...
        private void drawFrame() {
            ...
            try (MemoryStack stack = stackPush()) {
                ...
                int vkResult = vkAcquireNextImageKHR(device, swapChain, UINT64_MAX, thisFrame.imageAvailableSemaphore(),
        ...
        private boolean checkDeviceExtensionSupport(VkPhysicalDevice device) {
            ...
            try (MemoryStack stack = stackPush()) {
                ...
                VkExtensionProperties.Buffer availableExtensions = VkExtensionProperties
                        .mallocStack(extensionCount.get(0), stack);
        ...
        private QueueFamilyIndices findQueueFamilies(VkPhysicalDevice device) {
            ...
            try (MemoryStack stack = stackPush()) {
                ...
                VkQueueFamilyProperties.Buffer queueFamilies = VkQueueFamilyProperties
                        .mallocStack(queueFamilyCount.get(0), stack);
